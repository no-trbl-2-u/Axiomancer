> **Status:** HISTORICAL — archived 2026-09-25 by TRIM THE FAT T1 (`plan/2026-09-25-trim-the-fat.spec.md` Tier 1 docs). Original path: `axiomancer-mobile/docs/mechanics-ui-audit-2026-05-22-inventory.md`. Describes removed or never-built code; not a source of rules.
