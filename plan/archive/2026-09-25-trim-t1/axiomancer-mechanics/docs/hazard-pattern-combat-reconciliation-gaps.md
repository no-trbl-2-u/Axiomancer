> **Archived** 2026-09-25 by TRIM THE FAT T1 (`plan/2026-09-25-trim-the-fat.spec.md` Tier 1). Original path: `axiomancer-mechanics/docs/hazard-pattern-combat-reconciliation-gaps.md`.
