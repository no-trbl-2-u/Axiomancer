# Content lifecycle ledger — archive, 2026

> Append-only. Pass-log entries rotated verbatim out of `plan/CONTENT_LEDGER.md` (T4 plan/ compaction, 2026-09-25: adjust-* passes 1–18, cards/equipment/enemies to pass 18, keywords/npcs to pass 17); later rotations append below per the rotation rule in the `skills/adjust-*.md` Step 4.
