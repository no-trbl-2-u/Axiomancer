...
const STATUS_APPLYING_SLOTS: ReadonlySet<EquipmentSlot> = new Set<EquipmentSlot>([
    'weapon',
    // Phase 18: legacy 'hands' folded into 'accessory' (mechanical re-slot). The
    // gauntlet offensive-status bias now spans the whole accessory slot — an
    // accepted side effect; this affix machinery is deleted in phase 21.
    'accessory',
]);
