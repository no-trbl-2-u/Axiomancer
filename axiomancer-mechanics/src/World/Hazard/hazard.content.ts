...
export const HAZARD_LIBRARY: HazardDef[] = [
    ...
    },
    {
        ...
        intro: 'The fever came in with the marsh water. It is already past his elbow, drawing black lines toward the heart. Men twice his size have died of half this. He has a day, perhaps less. Unless…',
