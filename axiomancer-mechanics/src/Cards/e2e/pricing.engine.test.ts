...
describe('pricing table — pinned anchors from the spec §4 arithmetic', () => {
    ...
    it('the starter pair prices at its authored comments (regression anchors)', () => {
        ...
        // poison lifetime 10/3 + FREE MARK seed i1 d1 (0.75) = 4.08 (phase 30:
        // TICK retired registry-wide, replaced with the affliction glue seed)
        expect(scoreCard(slipperySlope)).toBeCloseTo(10 / 3 + 0.75, 2);
