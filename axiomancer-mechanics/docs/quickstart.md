...
| **Skills** | `executeCard` caster-agnostic (Phase 49), `learnCard` + runtime learning (Phase 30), Tier 1-3 skill library + Tier 2 synergy clauses (Phase 66) | 4, 4b, 30, 33, 44, 49, 66 | [skills.md](./skills.md) |
...
| Skills | [quickstart-skills.md](./quickstart-skills.md) | `executeCard`, resource generation, synergy events, Tier 1/2/3 |
