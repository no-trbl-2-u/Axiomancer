...
| Quest beats | `src/World/QuestBoard/quest-board.content.ts` (`storyBeat`) — Phase 61 deletes this minigame; check the build plan first. Quest defs: `src/World/quest.library.ts` | quest surfaces |
