...
const KEYWORD_WORDS = [
  ...
  // 2026-08-09 (phase 44b) — PREMISE/PERORATION/CONCEDE/SWAY/CAPITULATE/
  // RAPPORT/REARGUE renamed CHARGE/SENTENCE/CONDEMN/PLEA/RELENT/QUARTER/CURDLE.
...
const GLYPH_SHAPES = {
  ...
  // BARRIER deliberately absent: retired into GUARD by the Phase 29
  // keyword-registry pass (mirrors glyphShapes.ts; drift gate enforces).
  GUARD: SHAPE_SHIELD,
