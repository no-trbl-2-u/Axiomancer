 ...
 * status-proc pulse, number pop, the idle breath, standard enter/exit
 * transitions, the spent-die static treatment, and a haptics wrapper. Every animated
 * primitive is reduced-motion gated and honors the `__AXM_JUICE_INSTANT__`
