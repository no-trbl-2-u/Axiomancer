...
const html = `<!doctype html><html><head><meta charset="utf-8"><title>Axiomancer Table Edition — v1-to-v2 Patch (5 cards)</title>
<style>
...
</style></head><body>${pages[pages.length-1]}</body></html>`;

writeFileSync(new URL('./cards-patch.html', import.meta.url), html);
